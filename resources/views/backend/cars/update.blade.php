                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="warranty" value="{{$car->warranty}}" class="form-control"  placeholder="{{translate('أدخل ضمان السيارة')}}">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="engine_capacity">{{translate('سعة الموتور')}}</label>
                                <input type="text" name="engine_capacity" value="{{$car->engine_capacity}}" class="form-control"  placeholder="{{translate('أدخل سعة موتور السيارة')}}">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="horse_power" value="{{$car->horse_power}}" class="form-control"  placeholder="{{translate('أدخل عدد أحصنة الموتور')}}">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="maxmum_speed">{{translate('السرعة القصوي')}}</label>
                                <input type="text" name="maxmum_speed" value="{{$car->maxmum_speed}}" class="form-control"  placeholder="{{translate('أدخل السرعة القصوي')}}">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="transmittion">{{translate('ناقل الحركة')}}</label>
                                <input type="text" name="transmittion" value="{{$car->transmittion}}" class="form-control"  placeholder="{{translate('أدخل نوع ناقل الحركة')}}">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="year" value="{{$car->year}}" class="form-control"  placeholder="{{translate('أدخل سنة الصنع')}}">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="fuel">{{translate('نوع الوقود')}}</label>
                                <input type="text" name="fuel" value="{{$car->fuel}}" class="form-control"  placeholder="{{translate('أدخل نوع الوقود ')}}">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="fuel_usage">{{translate('استهلاك الوقود')}}</label>
                                <input type="text" name="fuel_usage" value="{{$car->fuel_usage}}" class="form-control"  placeholder="{{translate('أدخل استهلاك الوقود ')}}">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="country">{{translate('بلد الصنع')}}</label>
                                <input type="text" name="country" value="{{$car->country}}" class="form-control"  placeholder="{{translate('أدخل بلد الصنع ')}}">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="width" value="{{$car->width}}" class="form-control"  placeholder="{{translate('أدخل  عرض السيارة ')}}">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="ground_clearance">{{translate('ارتفاع السيارة عن الارض')}}</label>
                                <input type="text" name="ground_clearance" value="{{$car->ground_clearance}}" class="form-control"  placeholder="{{translate('أدخل  ارتفاع السيارة ')}}">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="wheel_base">{{translate('قاعدة العجلات')}}</label>
                                <input type="text" name="wheel_base" value="{{$car->wheel_base}}" class="form-control"  placeholder="{{translate('أدخل قاعدة العجلات')}}">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="trunk_size">{{translate('حجم الشنطة')}}</label>
                                <input type="text" name="trunk_size" value="{{$car->trunk_size}}" class="form-control"  placeholder="{{translate('أدخل حجم الشنطة')}}">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="seats">{{translate('عدد المقاعد')}}</label>
                                <input type="text" name="seats" value="{{$car->seats}}" class="form-control"  placeholder="{{translate('أدخل عدد مقاعد السيارة')}}">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="traction_type">{{translate('نوع الجر')}}</label>
                                <input type="text" name="traction_type" value="{{$car->traction_type}}" class="form-control"  placeholder="{{translate('أدخل نوع الجر')}}">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="clynder">{{translate('عدد السلندار ')}}</label>
                                <input type="text" name="clynder" value="{{$car->clynder}}" class="form-control"  placeholder="{{translate('أدخل عدد السلندار ')}}">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="fuel_tank_capacity">{{translate('سعة خزان الوقود')}}</label>
                                <input type="text" name="fuel_tank_capacity" value="{{$car->fuel_tank_capacity}}" class="form-control"  placeholder="{{translate('أدخل  سعة خزان الوقود ')}}">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
            ...
            <div class="tab-pane fade" id="custom-content-below-profile" role="tabpanel" aria-labelledby="custom-content-below-profile-tab">
               ...
               <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input class="custom-control-input" name="comfort" type="checkbox" id="customCheckbox1" value="شاشة متعددة الوسائط تعمل باللمس"  {{$car->comfort == 'شاشة متعددة الوسائط تعمل باللمس' ? 'checked' : ''}}>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-checkbox">
                            <input class="custom-control-input" name="windows" type="checkbox" id="customCheckbox2" value="نوافذ كهربائية أمامية" {{$car->windows == 'نوافذ كهربائية أمامية' ? 'checked' : ''}}>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-checkbox">
                            <input class="custom-control-input" name="sound_system" type="checkbox" id="customCheckbox3" value="نظام تحكم في الطارة" {{$car->sound_system == 'نظام تحكم في الطارة' ? 'checked' : ''}}>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-checkbox">
                            <input class="custom-control-input" name="safety" type="checkbox" id="customCheckbox4" value="نظام إيموبليزر ضد السرقة" {{$car->safety == 'نظام إيموبليزر ضد السرقة' ? 'checked' : ''}}>
                     ...
                     <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-checkbox">
                            <input class="custom-control-input" name="other" type="checkbox" id="customCheckbox5" value="مثبت سرعة" {{$car->other == 'مثبت سرعة' ? 'checked' : ''}}>
