          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                    {{ translate('تعديل معلومات المستخدم') }}
                </h3>
              </div>
                ...
                <form action="{{ route('user-update') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                                ...
                                <option Selected>{{translate('اختر وظيفة هذا الشخص')}}</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="email" value="{{$user->email}}" name="email" class="form-control mb-2" required />
                        </div>
                        <div class="col-md-6">
                        <div class="form-group">
